...
export interface Prisma {
  ...
  meditation: (where: MeditationWhereUniqueInput) => MeditationPromise;
  meditations: (
    args?: {
  ...
  updateMeditation: (
    args: { data: MeditationUpdateInput; where: MeditationWhereUniqueInput }
  ) => MeditationPromise;
  updateManyMeditations: (
    args: {
